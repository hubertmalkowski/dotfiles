...
vim.g['terminal_color_1'] = carbon.purple
vim.g['terminal_color_2'] = carbon.orange
vim.g['terminal_color_3'] = carbon.green
vim.g['terminal_color_4'] = carbon.pinkish
vim.g['terminal_color_5'] = carbon.cyan
vim.g['terminal_color_6'] = carbon.purple
vim.g['terminal_color_7'] = carbon.base05
vim.g['terminal_color_8'] = carbon.text_secondary
vim.g['terminal_color_9'] = carbon.purple
vim.g['terminal_color_10'] = carbon.orange
vim.g['terminal_color_11'] = carbon.green
vim.g['terminal_color_12'] = carbon.pinkish
vim.g['terminal_color_13'] = carbon.cyan
...
vim.api.nvim_set_hl(0, 'CursorLineNr', { fg = carbon.text, bg = carbon.none })
vim.api.nvim_set_hl(0, 'QuickFixLine', { fg = carbon.none, bg = carbon.layer2 })
vim.api.nvim_set_hl(0, 'Error', { fg = carbon.red, bg = carbon.layer2 })
vim.api.nvim_set_hl(0, 'LineNr', { fg = carbon.text_tertiary, bg = carbon.layer1 })
...
vim.api.nvim_set_hl(0, 'PmenuSel', { fg = carbon.purple, bg = carbon.highlight_blue })
vim.api.nvim_set_hl(0, 'PmenuThumb', { fg = carbon.purple, bg = carbon.text })
vim.api.nvim_set_hl(0, 'SpecialKey', { fg = carbon.text_secondary, bg = carbon.none })
vim.api.nvim_set_hl(0, 'Visual', { fg = carbon.none, bg = carbon.highlight_blue })
vim.api.nvim_set_hl(0, 'VisualNOS', { fg = carbon.none, bg = carbon.highlight_blue })
vim.api.nvim_set_hl(0, 'TooLong', { fg = carbon.none, bg = carbon.text })
vim.api.nvim_set_hl(0, 'Debug', { fg = carbon.green, bg = carbon.none })
vim.api.nvim_set_hl(0, 'Macro', { fg = carbon.blue, bg = carbon.none })
vim.api.nvim_set_hl(0, 'MatchParen', { fg = carbon.none, bg = carbon.highlight_blue, underline = true })
...
vim.api.nvim_set_hl(0, 'DiagnosticWarn', { fg = carbon.orange, bg = carbon.none })
vim.api.nvim_set_hl(0, 'DiagnosticError', { fg = carbon.red, bg = carbon.none })
...
vim.api.nvim_set_hl(0, 'DiagnosticUnderlineWarn', { fg = carbon.orange, bg = carbon.none, undercurl = true })
vim.api.nvim_set_hl(0, 'DiagnosticUnderlineError', { fg = carbon.red, bg = carbon.none, undercurl = true })
...
vim.api.nvim_set_hl(0, 'HealthError', { fg = carbon.red, bg = carbon.none })
vim.api.nvim_set_hl(0, 'HealthWarning', { fg = carbon.orange, bg = carbon.none })
vim.api.nvim_set_hl(0, 'HealthSuccess', { fg = carbon.green, bg = carbon.none })
vim.api.nvim_set_hl(0, '@comment', { link = 'Comment' })
vim.api.nvim_set_hl(0, '@text.literal.commodity', { fg = carbon.green, bg = carbon.none })
...
vim.api.nvim_set_hl(0, '@number.date.effective', { fg = carbon.green, bg = carbon.none })
vim.api.nvim_set_hl(0, '@number.interval', { fg = carbon.pinkish, bg = carbon.none })
vim.api.nvim_set_hl(0, '@number.status', { fg = carbon.blue, bg = carbon.none })
vim.api.nvim_set_hl(0, '@number.quantity', { fg = carbon.purple, bg = carbon.none })
vim.api.nvim_set_hl(0, '@number.quantity.negative', { fg = carbon.purple, bg = carbon.none })
vim.api.nvim_set_hl(0, 'LspCodeLens', { fg = carbon.none, bg = carbon.text_secondary })
...
vim.api.nvim_set_hl(0, 'ErrorMsg', { fg = carbon.red, bg = carbon.none })
...
vim.api.nvim_set_hl(0, 'WarningMsg', { fg = carbon.orange, bg = carbon.none })
...
vim.api.nvim_set_hl(0, 'helpHeadline', { fg = carbon.purple, bg = carbon.none })
vim.api.nvim_set_hl(0, 'helpHeader', { fg = carbon.cyan, bg = carbon.none })
...
vim.api.nvim_set_hl(0, 'DiffRemoved', { fg = carbon.purple, bg = carbon.none })
...
vim.api.nvim_set_hl(0, 'IncSearch', { fg = carbon.white, bg = carbon.purple })
...
vim.api.nvim_set_hl(0, 'Character', { fg = carbon.orange, bg = carbon.none })
vim.api.nvim_set_hl(0, 'Comment', { fg = carbon.text_tertiary, bg = carbon.none, italic = true })
...
vim.api.nvim_set_hl(0, 'Decorator', { fg = carbon.blue, bg = carbon.none })
...
vim.api.nvim_set_hl(0, 'String', { fg = carbon.green, bg = carbon.none })
...
vim.api.nvim_set_hl(0, 'Todo', { fg = carbon.green, bg = carbon.none })
...
vim.api.nvim_set_hl(0, 'markdownH1', { fg = carbon.purple, bg = carbon.none })
...
vim.api.nvim_set_hl(0, 'markdownUrl', { fg = carbon.orange, bg = carbon.none, underline = true })
...
vim.api.nvim_set_hl(0, 'asciidocAttributeEntry', { fg = carbon.cyan, bg = carbon.none })
...
vim.api.nvim_set_hl(0, '@comment', { link = 'Comment' })
vim.api.nvim_set_hl(0, '@error', { fg = carbon.purple, bg = carbon.none })
vim.api.nvim_set_hl(0, '@operator', { link = 'Operator' })
vim.api.nvim_set_hl(0, '@punctuation.delimiter', { fg = carbon.text, bg = carbon.none })
vim.api.nvim_set_hl(0, '@punctuation.bracket', { fg = carbon.text, bg = carbon.none })
...
vim.api.nvim_set_hl(0, '@string.escape', { fg = carbon.cyan, bg = carbon.none })
vim.api.nvim_set_hl(0, '@character', { link = 'Character' })
vim.api.nvim_set_hl(0, '@boolean', { link = 'Boolean' })
vim.api.nvim_set_hl(0, '@number', { link = 'Number' })
vim.api.nvim_set_hl(0, '@float', { link = 'Float' })
vim.api.nvim_set_hl(0, '@function', { fg = carbon.blue, bg = carbon.none, bold = true })
vim.api.nvim_set_hl(0, '@function.builtin', { fg = carbon.blue, bg = carbon.none })
...
vim.api.nvim_set_hl(0, '@conditional', { fg = carbon.pinkish, bg = carbon.none })
vim.api.nvim_set_hl(0, '@repeat', { fg = carbon.pinkish, bg = carbon.none })
vim.api.nvim_set_hl(0, '@label', { fg = carbon.cyan, bg = carbon.none })
vim.api.nvim_set_hl(0, '@include', { fg = carbon.pinkish, bg = carbon.none })
vim.api.nvim_set_hl(0, '@exception', { fg = carbon.cyan, bg = carbon.none })
vim.api.nvim_set_hl(0, '@type', { link = 'Type' })
vim.api.nvim_set_hl(0, '@type.builtin', { link = 'Type' })
vim.api.nvim_set_hl(0, '@attribute', { fg = carbon.cyan, bg = carbon.none })
...
vim.api.nvim_set_hl(0, '@constant', { fg = carbon.cyan, bg = carbon.none })
...
vim.api.nvim_set_hl(0, '@symbol', { fg = carbon.cyan, bg = carbon.none, bold = true })
...
vim.api.nvim_set_hl(0, '@text.emphasis', { fg = carbon.purple, bg = carbon.none, bold = true })
vim.api.nvim_set_hl(0, '@text.underline', { fg = carbon.purple, bg = carbon.none, underline = true })
vim.api.nvim_set_hl(0, '@text.strike', { fg = carbon.purple, bg = carbon.none, strikethrough = true })
vim.api.nvim_set_hl(0, '@text.title', { fg = carbon.purple, bg = carbon.none })
...
vim.api.nvim_set_hl(0, 'StatusInsert', { fg = carbon.layer1, bg = carbon.blue })
vim.api.nvim_set_hl(0, 'StatusVisual', { fg = carbon.layer1, bg = carbon.orange })
vim.api.nvim_set_hl(0, 'StatusTerminal', { fg = carbon.layer1, bg = carbon.purple })
vim.api.nvim_set_hl(0, 'StatusNormal', { fg = carbon.layer1, bg = carbon.cyan })
vim.api.nvim_set_hl(0, 'StatusCommand', { fg = carbon.layer1, bg = carbon.green })
vim.api.nvim_set_hl(0, 'StatusLineDiagnosticWarn', { fg = carbon.orange, bg = carbon.layer1, bold = true })
vim.api.nvim_set_hl(0, 'StatusLineDiagnosticError', { fg = carbon.purple, bg = carbon.layer1, bold = true })
...
vim.api.nvim_set_hl(0, 'TelescopePromptNormal', { fg = carbon.base05, bg = carbon.highlight_blue })
...
vim.api.nvim_set_hl(0, 'TelescopePreviewTitle', { fg = carbon.text, bg = carbon.blue })
vim.api.nvim_set_hl(0, 'TelescopePromptTitle', { fg = carbon.text, bg = carbon.purple })
vim.api.nvim_set_hl(0, 'TelescopeResultsTitle', { fg = carbon.blend, bg = carbon.layer2 })
vim.api.nvim_set_hl(0, 'TelescopeSelection', { fg = carbon.none, bg = carbon.layer2 })
...
vim.api.nvim_set_hl(0, 'NotifyWARNBorder', { fg = carbon.orange, bg = carbon.none })
vim.api.nvim_set_hl(0, 'NotifyINFOBorder', { fg = carbon.base05, bg = carbon.none })
vim.api.nvim_set_hl(0, 'NotifyDEBUGBorder', { fg = carbon.green, bg = carbon.none })
vim.api.nvim_set_hl(0, 'NotifyTRACEBorder', { fg = carbon.green, bg = carbon.none })
vim.api.nvim_set_hl(0, 'NotifyERRORIcon', { fg = carbon.purple, bg = carbon.none })
vim.api.nvim_set_hl(0, 'NotifyWARNIcon', { fg = carbon.orange, bg = carbon.none })
vim.api.nvim_set_hl(0, 'NotifyINFOIcon', { fg = carbon.base05, bg = carbon.none })
vim.api.nvim_set_hl(0, 'NotifyDEBUGIcon', { fg = carbon.green, bg = carbon.none })
vim.api.nvim_set_hl(0, 'NotifyTRACEIcon', { fg = carbon.green, bg = carbon.none })
vim.api.nvim_set_hl(0, 'NotifyERRORTitle', { fg = carbon.purple, bg = carbon.none })
vim.api.nvim_set_hl(0, 'NotifyWARNTitle', { fg = carbon.orange, bg = carbon.none })
vim.api.nvim_set_hl(0, 'NotifyINFOTitle', { fg = carbon.base05, bg = carbon.none })
vim.api.nvim_set_hl(0, 'NotifyDEBUGTitle', { fg = carbon.green, bg = carbon.none })
vim.api.nvim_set_hl(0, 'NotifyTRACETitle', { fg = carbon.green, bg = carbon.none })
vim.api.nvim_set_hl(0, 'CmpItemAbbr', { fg = carbon.text_tertiary, bg = carbon.none })
vim.api.nvim_set_hl(0, 'CmpItemAbbrMatch', { fg = carbon.text_primary, bg = carbon.none, bold = true })
vim.api.nvim_set_hl(0, 'CmpItemSelected', { bg = '#ff0000' })
vim.api.nvim_set_hl(0, 'CmpItemAbbrMatchFuzzy', { bg = carbon.brightish_whitish, fg = carbon.none, bold = true })
vim.api.nvim_set_hl(0, 'CmpItemMenu', { bg = carbon.brightish_whitish, fg = carbon.none, italic = true })
vim.api.nvim_set_hl(0, 'CmpItemKindInterface', { bg = carbon.layer2, fg = carbon.purple })
vim.api.nvim_set_hl(0, 'CmpItemKindColor', { bg = carbon.layer2, fg = carbon.purple })
vim.api.nvim_set_hl(0, 'CmpItemKindTypeParameter', { bg = carbon.layer2, fg = carbon.purple })
vim.api.nvim_set_hl(0, 'CmpItemKindText', { bg = carbon.layer2, fg = carbon.pinkish })
vim.api.nvim_set_hl(0, 'CmpItemKindEnum', { bg = carbon.layer2, fg = carbon.pinkish })
vim.api.nvim_set_hl(0, 'CmpItemKindKeyword', { bg = carbon.layer2, fg = carbon.pinkish })
vim.api.nvim_set_hl(0, 'CmpItemKindConstant', { bg = carbon.layer2, fg = carbon.blue })
vim.api.nvim_set_hl(0, 'CmpItemKindConstructor', { bg = carbon.layer2, fg = carbon.blue })
vim.api.nvim_set_hl(0, 'CmpItemKindReference', { bg = carbon.layer2, fg = carbon.blue })
vim.api.nvim_set_hl(0, 'CmpItemKindFunction', { bg = carbon.layer2, fg = carbon.blue })
vim.api.nvim_set_hl(0, 'CmpItemKindStruct', { bg = carbon.layer2, fg = carbon.blue })
vim.api.nvim_set_hl(0, 'CmpItemKindClass', { bg = carbon.layer2, fg = carbon.blue })
vim.api.nvim_set_hl(0, 'CmpItemKindModule', { bg = carbon.layer2, fg = carbon.blue })
vim.api.nvim_set_hl(0, 'CmpItemKindOperator', { bg = carbon.layer2, fg = carbon.blue })
vim.api.nvim_set_hl(0, 'CmpItemKindField', { bg = carbon.layer2, fg = carbon.blue })
vim.api.nvim_set_hl(0, 'CmpItemKindProperty', { bg = carbon.layer2, fg = carbon.blue })
vim.api.nvim_set_hl(0, 'CmpItemKindEvent', { bg = carbon.layer2, fg = carbon.blue })
vim.api.nvim_set_hl(0, 'CmpItemKindUnit', { bg = carbon.layer2, fg = carbon.green })
vim.api.nvim_set_hl(0, 'CmpItemKindSnippet', { bg = carbon.layer2, fg = carbon.green })
vim.api.nvim_set_hl(0, 'CmpItemKindFolder', { bg = carbon.layer2, fg = carbon.green })
vim.api.nvim_set_hl(0, 'CmpItemKindVariable', { bg = carbon.layer2, fg = carbon.white })
vim.api.nvim_set_hl(0, 'CmpItemKindFile', { bg = carbon.layer2, fg = carbon.orange })
vim.api.nvim_set_hl(0, 'CmpItemKindMethod', { bg = carbon.layer2, fg = carbon.cyan })
vim.api.nvim_set_hl(0, 'CmpItemKindValue', { bg = carbon.layer2, fg = carbon.cyan })
vim.api.nvim_set_hl(0, 'CmpItemKindEnumMember', { bg = carbon.layer2, fg = carbon.cyan })
vim.api.nvim_set_hl(0, 'NvimTreeImageFile', { fg = carbon.blue, bg = carbon.none })
vim.api.nvim_set_hl(0, 'NvimTreeFolderIcon', { fg = carbon.blue, bg = carbon.none })
...
vim.api.nvim_set_hl(0, 'NvimTreeEmptyFolderName', { fg = carbon.cyan, bg = carbon.none })
vim.api.nvim_set_hl(0, 'NvimTreeOpenedFolderName', { fg = carbon.cyan, bg = carbon.none })
vim.api.nvim_set_hl(0, 'NvimTreeNormal', { fg = carbon.brightish_whitish, bg = carbon.layer1 })
vim.api.nvim_set_hl(0, 'NeogitBranch', { fg = carbon.purple, bg = carbon.none })
...
vim.api.nvim_set_hl(0, 'NeogitHunkHeaderHighlight', { fg = carbon.brightish_whitish, bg = carbon.text_secondary })
vim.api.nvim_set_hl(0, 'HydraRed', { fg = carbon.blue, bg = carbon.none })
vim.api.nvim_set_hl(0, 'HydraBlue', { fg = carbon.pinkish, bg = carbon.none })
vim.api.nvim_set_hl(0, 'HydraAmaranth', { fg = carbon.purple, bg = carbon.none })
...
vim.api.nvim_set_hl(0, 'alpha1', { fg = carbon.text_secondary, bg = carbon.none })
vim.api.nvim_set_hl(0, 'alpha2', { fg = carbon.brightish_whitish, bg = carbon.none })
vim.api.nvim_set_hl(0, 'alpha3', { fg = carbon.text_secondary, bg = carbon.none })
vim.api.nvim_set_hl(0, 'CodeBlock', { fg = carbon.none, bg = carbon.layer2 })
vim.api.nvim_set_hl(0, 'BufferLineDiagnostic', { fg = carbon.purple, bg = carbon.none, bold = true })
vim.api.nvim_set_hl(0, 'BufferLineDiagnosticVisible', { fg = carbon.purple, bg = carbon.none, bold = true })
